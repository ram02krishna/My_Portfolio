          ...
          <div className="glass overflow-hidden rounded-2xl border border-border shadow-[var(--shadow-glow)]">
            ...
            <pre className="overflow-x-auto bg-secondary/20 p-4 font-mono text-[11px] leading-6 sm:p-5 sm:text-sm sm:leading-7">
              <code>
                ...
                <div className="flex gap-3 sm:gap-4"><span className="select-none text-muted-foreground/50">04</span><span><span style={{ color: "var(--code-keyword)" }}>const</span> <span style={{ color: "var(--code-variable)" }}>ratings</span> <span className="text-muted-foreground">=</span> {"{ "}<span style={{ color: "var(--code-property)" }}>cf</span>: <span style={{ color: "var(--code-number)" }}>731</span>, <span style={{ color: "var(--code-property)" }}>lc</span>: <span style={{ color: "var(--code-number)" }}>1572</span>, <span style={{ color: "var(--code-property)" }}>cc</span>: <span style={{ color: "var(--code-number)" }}>1385</span> {"}"};</span></div>
